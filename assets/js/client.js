...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reflux = __webpack_require__(177);

	var _reflux2 = _interopRequireDefault(_reflux);

	var _TodoStore = __webpack_require__(196);

	var _TodoStore2 = _interopRequireDefault(_TodoStore);

	var _CreateTodo = __webpack_require__(198);
	...
	var _ToolBar = __webpack_require__(202);
	...
	var Ctx = _morearty2.default.createContext(state, {}, {});
	(0, _TodoStore2.default)(Ctx);
	...
	var App = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(_CreateTodo2.default, { binding: binding }),
	            _react2.default.createElement(_TodoList2.default, { binding: binding }),
	            _react2.default.createElement(_ToolBar2.default, { binding: binding })
	        );
	    }
	});
	...
	_reactDom2.default.render(_react2.default.createElement(Bootstrap, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOM = __webpack_require__(169);
	module.exports = __webpack_require__(171)(React, DOM);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = function () {
	  if (React) return React.DOM;else {
	    throw new Error('Morearty: global variable React not found');
	  }
	}();

	var wrapComponent = function wrapComponent(comp, displayName) {
...
/***/ function(module, exports) {
	...
	isRequired = function isRequired(spec) {
	  return typeof spec === 'string' && spec.charAt(0) !== '?';
	};

	findTurningPoint = function findTurningPoint(arr, pred) {
	...
	prepare = function prepare(arr, splitAt) {
	...
	module.exports = {
	   ...
	   * @memberOf Util */
	  afterComplete: function afterComplete(f, cont) {
	    var result = f();
	   ...
	   * @returns {Boolean}
	   * @memberOf Util */
	  undefinedOrNull: function undefinedOrNull(x) {
	   ...
	   * @memberOf Util */
	  getPropertyValues: function getPropertyValues(obj) {
	   ...
	   * @memberOf Util */
	  resolveArgs: function resolveArgs(args, var_args) {
	    var result = {};
	    if (arguments.length > 1) {
	   ...
	   * @returns {Boolean}
	   * @memberOf Util */
	  canRepresentSubpath: function canRepresentSubpath(x) {
	   ...
	   * @memberOf Util */
	  joinPaths: function joinPaths(path1, path2) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var Imm = __webpack_require__(172);
	var Util = __webpack_require__(170);
	var Binding = __webpack_require__(173);
	var History = __webpack_require__(175);
	var Callback = __webpack_require__(176);
	...
	var _getBinding, bindingStateChanged, stateChanged;

	_getBinding = function getBinding(props, key) {
	  var binding = props.binding;
	  return key ? binding[key] : binding;
	};

	bindingStateChanged = function bindingStateChanged(context, currentBinding, previousState, previousMetaState) {
	  return context._stateChanged && previousState !== currentBinding.get() || context._metaChanged && context._metaBinding.sub(currentBinding.getPath()).isChanged(previousMetaState);
	};

	stateChanged = function stateChanged(self, currentBinding, previousBinding, previousState, previousMetaState) {
	  if (!currentBinding) return false;else {
	    ...
	    if (currentBinding instanceof Binding) {
	      ...
	      if (context._stateChanged || context._metaChanged) {
	        ...
	        return !!Util.find(keys, function (key) {
	          ...
	          return binding && (binding !== previousBinding[key] || bindingStateChanged(context, binding, previousState[key], previousMetaState));
	        });
	      } else {
	        return false;
	      }
	...
	propChanged = function propChanged(prop, currentProps, previousProps) {
	  return currentProps[prop] !== previousProps[prop];
	};

	countProps = function countProps(props) {
	  var count = 0;
	...
	propsChanged = function propsChanged(self, currentProps) {
	...
	var merge = function merge(mergeStrategy, defaultState, stateBinding) {
	  ...
	  if (typeof mergeStrategy === 'function') {
	    ...
	    switch (mergeStrategy) {
	      ...
	      case MERGE_STRATEGY.OVERWRITE_EMPTY:
	        tx = tx.update(function (currentState) {
	          var empty = Util.undefinedOrNull(currentState) || currentState instanceof Imm.Iterable && currentState.isEmpty();
	...
	var getRenderRoutine = function getRenderRoutine(self) {
	  var requestAnimationFrame = typeof window !== 'undefined' && window.requestAnimationFrame;
	  var fallback = function fallback(f) {
	    setTimeout(f, 1000 / 60);
	  };

	  if (self._options.requestAnimationFrameEnabled) {
	    if (requestAnimationFrame) return requestAnimationFrame;else {
	...
	initState = function initState(self, getStateMethodName, f) {
	  if (typeof self[getStateMethodName] === 'function') {
	    var defaultStateValue = self[getStateMethodName]();
	    if (defaultStateValue) {
	      var binding = _getBinding(self.props);
	      var mergeStrategy = typeof self.getMergeStrategy === 'function' ? self.getMergeStrategy() : MERGE_STRATEGY.MERGE_PRESERVE;
	...
	initDefaultState = function initDefaultState(self) {
	  initState(self, 'getDefaultState', Util.identity);
	};

	initDefaultMetaState = function initDefaultMetaState(self) {
	  initState(self, 'getDefaultMetaState', function (b) {
	    return b.meta();
	  });
	};

	savePreviousState = function savePreviousState(self) {
	...
	addComponentToRenderQueue = function addComponentToRenderQueue(self, component) {
	  self._componentQueue[component.componentQueueId] = component;
	};

	removeComponentFromRenderQueue = function removeComponentFromRenderQueue(self, component) {
	  delete self._componentQueue[component.componentQueueId];
	};

	getUniqueComponentQueueId = function getUniqueComponentQueueId(self) {
	  return self ? ++self._lastComponentQueueId : 0;
	};

	setupObservedBindingListener = function setupObservedBindingListener(self, binding) {
	...
	module.exports = function (React, DOM) {
	   ...
	   *   <li>[DOM]{@link DOM}.</li>
	   * </ul> */
	  var Context = function Context(binding, metaBinding, options) {
	    /** @private */
	  ...
	  var contextPrototype = {
	     ...
	     * @see Binding */
	    getMetaBinding: function getMetaBinding() {
	    ...
	    getCurrentMeta: function getCurrentMeta() {
	    ...
	    getPreviousMeta: function getPreviousMeta() {
	    ...
	    resetState: function resetState(subpath, options) {
	     ...
	     * @param {Object} [options] options object
	     * @param {Boolean} [options.notify=true] should listeners be notified */
	    replaceState: function replaceState(newState, newMetaState, options) {
	      var args = Util.resolveArgs(arguments, 'newState', function (x) {
	        return x instanceof Imm.Map ? 'newMetaState' : null;
	      }, '?options');
	    ...
	    isChanged: function isChanged(binding, subpath, compare) {
	    ...
	    init: function init(rootComp) {
	      var self = this;
	      var stop = false;
	      var renderQueue = [];

	      var transitionState = function transitionState() {
	      ...
	      var forceUpdate = function forceUpdate(comp, f) {
	        if (comp.isMounted()) {
	          comp.forceUpdate(f);
	        }
	      };

	      var catchingRenderErrors = function catchingRenderErrors(f) {
	        try {
	          f();
	        } catch (e) {
	    ...
	    queueFullUpdate: function queueFullUpdate() {
	    ...
	    bootstrap: function bootstrap(rootComp, reactContext) {
	      var ctx = this;
	  ...
	  return {
	    ...
	    Mixin: {
	       ...
	       * @returns {Context} */
	      getMoreartyContext: function getMoreartyContext() {
	      ...
	      getBinding: function getBinding(name) {
	        return _getBinding(this.props, name);
	      },
	      ...
	      getDefaultBinding: function getDefaultBinding() {
	        var binding = _getBinding(this.props);
	        if (binding) {
	          if (binding instanceof Binding) {
	            return binding;
	      ...
	      getPreviousState: function getPreviousState(name) {
	        var ctx = this.getMoreartyContext();
	        return _getBinding(this.props, name).withBackingValue(ctx._previousState).get();
	      },
	      ...
	      observeBinding: function observeBinding(binding, cb) {
	        if (!this.observedBindings) {
	          this.observedBindings = [];
	        }

	        var bindingPath = binding.getPath();
	        if (!Util.find(this.observedBindings, function (b) {
	      ...
	      shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState, nextContext) {
	        ...
	        var shouldComponentUpdate = function shouldComponentUpdate() {
	          return ctx._fullUpdateInProgress || stateChanged(self, _getBinding(nextProps), _getBinding(self.props), previousState, previousMetaState) || propsChanged(self, nextProps);
	        };

	        var shouldComponentUpdateOverride = self.shouldComponentUpdateOverride;
	        return shouldComponentUpdateOverride ? shouldComponentUpdateOverride(shouldComponentUpdate, nextProps, nextState, nextContext) : shouldComponentUpdate();
	      },
	      ...
	      addBindingListener: function addBindingListener(binding, subpath, cb) {
	        var args = Util.resolveArgs(arguments, function (x) {
	     ...
	     * @return {Context}
	     * @memberOf Morearty */
	    createContext: function createContext(spec) {
	      ...
	      var ensureImmutable = function ensureImmutable(state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Imm = __webpack_require__(172);
	var Util = __webpack_require__(170);
	var ChangesDescriptor = __webpack_require__(174);
	...
	getBackingValue = function getBackingValue(binding) {
	  return binding._sharedInternals.backingValue;
	};

	setBackingValue = function setBackingValue(binding, newBackingValue) {
	...
	var setOrUpdate, updateValue, removeValue, _merge, _clear;

	setOrUpdate = function setOrUpdate(rootValue, effectivePath, f) {
	  return rootValue.updateIn(effectivePath, UNSET_VALUE, function (value) {
	    return value === UNSET_VALUE ? f() : f(value);
	  });
	};

	updateValue = function updateValue(self, subpath, f) {
	...
	removeValue = function removeValue(self, subpath) {
	  var effectivePath = Util.joinPaths(self._path, subpath);
	  var backingValue = getBackingValue(self);
	...
	_merge = function merge(preserve, newValue, value) {
	...
	_clear = function clear(value) {
	  return value instanceof Imm.Iterable ? value.clear() : null;
	};

	var mkStateTransition = function mkStateTransition(currentBackingValue, previousBackingValue, currentBackingMeta, previousBackingMeta, metaMetaChanged) {
	  return {
	...
	notifyListeners = function notifyListeners(self, samePathListeners, listenerPath, path, stateTransition) {
	  ...
	  Util.getPropertyValues(samePathListeners).forEach(function (listenerDescriptor) {
	    if (!listenerDescriptor.disabled) {
	      ...
	      var valueChanged = currentBackingValue !== previousBackingValue && currentBackingValue.getIn(listenerPathAsArray) !== previousBackingValue.getIn(listenerPathAsArray);
	      var metaChanged = stateTransition.metaMetaChanged || previousBackingMeta && currentBackingMeta !== previousBackingMeta && currentBackingMeta.getIn(listenerPathAsArray) !== previousBackingMeta.getIn(listenerPathAsArray);

	      if (valueChanged || metaChanged) {
	        listenerDescriptor.cb(new ChangesDescriptor(path, listenerPathAsArray, valueChanged, metaChanged, stateTransition));
	      }
	    }
	  });
	};

	notifyGlobalListeners = function notifyGlobalListeners(self, path, stateTransition) {
	...
	isPathAffected = function isPathAffected(listenerPath, changedPath) {
	  return changedPath === '' || listenerPath === changedPath || startsWith(changedPath, listenerPath + PATH_SEPARATOR) || startsWith(listenerPath, changedPath + PATH_SEPARATOR);
	};

	notifyNonGlobalListeners = function notifyNonGlobalListeners(self, path, stateTransition) {
	  var listeners = self._sharedInternals.listeners;
	...
	notifyAllListeners = function notifyAllListeners(self, path, stateTransition) {
	  notifyGlobalListeners(self, path, stateTransition);
	  notifyNonGlobalListeners(self, path, stateTransition);
	};

	var linkMeta, _unlinkMeta;

	linkMeta = function linkMeta(self, metaBinding) {
	  self._sharedInternals.metaBindingListenerId = metaBinding.addListener(function (changes) {
	    ...
	    notifyAllListeners(self, changedPath, mkStateTransition(backingValue, backingValue, getBackingValue(metaBinding), previousBackingMeta, metaMetaChanged));
	  });
	};

	_unlinkMeta = function unlinkMeta(self, metaBinding) {
	...
	findSamePathListeners = function findSamePathListeners(self, listenerId) {
	...
	setListenerDisabled = function setListenerDisabled(self, listenerId, disabled) {
	...
	_update = function update(self, subpath, f) {
	  ...
	  notifyAllListeners(self, affectedPath, mkStateTransition(getBackingValue(self), previousBackingValue, backingMeta, backingMeta));
	};

	delete_ = function delete_(self, subpath) {
	  var previousBackingValue = getBackingValue(self);
	 ...
	 * </ul>
	 * @see Binding.init */
	var Binding = function Binding(path, sharedInternals) {
	  /** @private */
	...
	var bindingPrototype = {
	  ...
	  withBackingValue: function withBackingValue(newBackingValue) {
	  ...
	  isChanged: function isChanged(alternativeBackingValue, compare) {
	    var value = this.get();
	    var alternativeValue = alternativeBackingValue ? alternativeBackingValue.getIn(this._path) : undefined;
	    return compare ? !compare(value, alternativeValue) : !(value === alternativeValue || Util.undefinedOrNull(value) && Util.undefinedOrNull(alternativeValue));
	  },
	   ...
	   * @return {Boolean} */
	  isRelative: function isRelative(otherBinding) {
	    return this._sharedInternals === otherBinding._sharedInternals && this._sharedInternals.backingValue === otherBinding._sharedInternals.backingValue;
	  },
	  ...
	  unlinkMeta: function unlinkMeta() {
	    var metaBinding = this._sharedInternals.metaBinding;
	    return metaBinding ? _unlinkMeta(this, metaBinding) : false;
	  },

	  /** Get binding value.
	   * @param {String|Array} [subpath] subpath as a dot-separated string or an array of strings and numbers
	   * @return {*} value at path or null */
	  get: function get(subpath) {
	  ...
	  update: function update(subpath, f) {
	    var args = Util.resolveArgs(arguments, '?subpath', 'f');
	    _update(this, args.subpath, args.f);
	    return this;
	  },
	   ...
	   * @return {Binding} this binding */
	  set: function set(subpath, newValue) {
	    var args = Util.resolveArgs(arguments, '?subpath', 'newValue');
	    _update(this, args.subpath, Util.constantly(args.newValue));
	    return this;
	  },
	   ...
	   * @param {String|Array} [subpath] subpath as a dot-separated string or an array of strings and numbers
	   * @return {Binding} this binding */
	  remove: function remove(subpath) {
	   ...
	   * @param {*} newValue new value
	   * @return {Binding} this binding */
	  merge: function merge(subpath, preserve, newValue) {
	    var args = Util.resolveArgs(arguments, function (x) {
	      return Util.canRepresentSubpath(x) ? 'subpath' : null;
	    }, '?preserve', 'newValue');
	    _update(this, args.subpath, _merge.bind(null, args.preserve, args.newValue));
	    return this;
	  },
	  ...
	  addListener: function addListener(subpath, cb) {
	    var args = Util.resolveArgs(arguments, function (x) {
	      return Util.canRepresentSubpath(x) ? 'subpath' : null;
	    }, 'cb');
	   ...
	   * @return {String} unique id which should be used to un-register the listener
	   * @see ChangesDescriptor */
	  addOnceListener: function addOnceListener(subpath, cb) {
	    var args = Util.resolveArgs(arguments, function (x) {
	      return Util.canRepresentSubpath(x) ? 'subpath' : null;
	    }, 'cb');
	   ...
	   * @return {Binding} this binding */
	  enableListener: function enableListener(listenerId) {
	   ...
	   * @param {String} listenerId listener id
	   * @return {Binding} this binding */
	  disableListener: function disableListener(listenerId) {
	   ...
	   * @return {Binding} this binding */
	  withDisabledListener: function withDisabledListener(listenerId, f) {
	  ...
	  removeListener: function removeListener(listenerId) {
	    var samePathListeners = findSamePathListeners(this, listenerId);
	  ...
	  atomically: function atomically(promise) {
	...
	var TransactionContext = function TransactionContext(binding, promise) {
	  /** @private */
	...
	TransactionContext.prototype = function () {
	  ...
	  registerUpdate = function registerUpdate(self, binding) {
	    if (!self._hasChanges) {
	  ...
	  addDeletion = function addDeletion(self, binding, subpath) {
	    registerUpdate(self, binding);
	    self._queuedUpdates.push({ binding: binding, subpath: subpath, type: UPDATE_TYPE.DELETE });
	  };

	  areSiblings = function areSiblings(path1, path2) {
	  ...
	  filterRedundantPaths = function filterRedundantPaths(affectedPaths) {
	  ...
	  commitSilently = function commitSilently(self) {
	    var finishedUpdates = self._queuedUpdates.map(function (update) {
	      var previousBackingValue = getBackingValue(update.binding);
	      var affectedPath = update.type === UPDATE_TYPE.UPDATE ? updateValue(update.binding, update.subpath, update.update) : removeValue(update.binding, update.subpath);
	  ...
	  var revert = function revert(self) {
	    ...
	    if (finishedUpdates.length > 0) {
	      ...
	      for (var i = finishedUpdates.length; i-- > 0;) {
	        ...
	        var relativeAffectedPath = binding.getPath().length === affectedPath.length ? affectedPath : affectedPath.slice(binding.getPath().length);
	  ...
	  var _cancel = function _cancel(self) {
	    if (self.isCommitted()) {
	      revert(self);
	    }
	  ...
	  var transactionContextPrototype = {
	    ...
	    update: function update(binding, subpath, f) {
	      var args = Util.resolveArgs(arguments, function (x) {
	        return x instanceof Binding ? 'binding' : null;
	      }, '?subpath', 'f');
	    ...
	    set: function set(binding, subpath, newValue) {
	      var args = Util.resolveArgs(arguments, function (x) {
	        return x instanceof Binding ? 'binding' : null;
	      }, '?subpath', 'newValue');
	     ...
	     * @param {String|Array} [subpath] subpath as a dot-separated string or an array of strings and numbers
	     * @return {TransactionContext} updated transaction context */
	    remove: function remove(binding, subpath) {
	      var args = Util.resolveArgs(arguments, function (x) {
	        return x instanceof Binding ? 'binding' : null;
	      }, '?subpath');
	     ...
	     * @param {*} newValue new value
	     * @return {TransactionContext} updated transaction context */
	    merge: function merge(binding, subpath, preserve, newValue) {
	      var args = Util.resolveArgs(arguments, function (x) {
	        return x instanceof Binding ? 'binding' : null;
	      }, function (x) {
	        return Util.canRepresentSubpath(x) ? 'subpath' : null;
	      ...
	      return this.update(args.binding, args.subpath, _merge.bind(null, args.preserve, args.newValue));
	    },
	     ...
	     * @param {String|Array} [subpath] subpath as a dot-separated string or an array of strings and numbers
	     * @return {TransactionContext} updated transaction context */
	    clear: function clear(binding, subpath) {
	      var args = Util.resolveArgs(arguments, function (x) {
	        return x instanceof Binding ? 'binding' : null;
	      }, '?subpath');
	      addUpdate(this, args.binding || this._binding, _clear, asArrayPath(args.subpath));
	      return this;
	    },
	      ...
	      if (!this.isCommitted()) {
	        if (!this.isCancelled() && hasChanges(this)) {
	          ...
	          if (effectiveOptions.notify !== false) {
	            ...
	            var stateTransition = mkStateTransition(getBackingValue(binding), previousBackingValue, getBackingValue(metaBinding), previousBackingMeta);
	    ...
	    isCommitted: function isCommitted() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChangesDescriptor = function ChangesDescriptor(path, listenerPath, valueChanged, metaChanged, stateTransition) {
	  /** @private */
	  this._path = path;
	  /** @private */
	...
	ChangesDescriptor.prototype = {
	   ...
	   * @returns {Boolean} */
	  isMetaChanged: function isMetaChanged() {
	   ...
	   * @protected
	   * @returns {*} */
	  getPreviousBackingValue: function getPreviousBackingValue() {
	   ...
	   * @protected
	   * @returns {*} */
	  getPreviousBackingMeta: function getPreviousBackingMeta() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	getHistoryBinding = function getHistoryBinding(binding) {
	  return binding.meta('history');
	};

	initHistory = function initHistory(historyBinding) {
	  historyBinding.set(Imm.fromJS({ listenerId: null, undo: [], redo: [] }));
	};

	clearHistory = function clearHistory(historyBinding) {
	  var listenerId = historyBinding.get('listenerId');
	  historyBinding.withDisabledListener(listenerId, function () {
	    historyBinding.atomically().set('undo', Imm.List.of()).set('redo', Imm.List.of()).commit();
	  });
	};

	destroyHistory = function destroyHistory(binding, notify) {
	...
	listenForChanges = function listenForChanges(binding, historyBinding) {
	...
	revertToStep = function revertToStep(path, value, listenerId, binding) {
	  binding.withDisabledListener(listenerId, function () {
	    binding.set(path, value);
	  });
	};

	revert = function revert(binding, fromBinding, toBinding, listenerId, valueProperty) {
	  var from = fromBinding.get();
	  if (!from.isEmpty()) {
	    var step = from.get(0);

	    fromBinding.atomically().remove(0).update(toBinding, function (to) {
	...
	var History = {
	   ...
	   * @param {Boolean} [options.notify=true] should listeners be notified
	   * @memberOf History */
	  destroy: function destroy(binding, options) {
	    var effectiveOptions = options || {};
	   ...
	   * @returns {Boolean}
	   * @memberOf History */
	  hasUndo: function hasUndo(binding) {
	    var historyBinding = getHistoryBinding(binding);
	   ...
	   * @returns {Boolean}
	   * @memberOf History */
	  hasRedo: function hasRedo(binding) {
	    var historyBinding = getHistoryBinding(binding);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	   ...
	   * @memberOf Callback */
	  set: function set(binding, subpath, f) {
	    var args = Util.resolveArgs(arguments, 'binding', function (x) {
	      return Util.canRepresentSubpath(x) ? 'subpath' : null;
	    }, '?f');
	   ...
	   * @returns {Function} callback
	   * @memberOf Callback */
	  remove: function remove(binding, subpath, pred) {
	    var args = Util.resolveArgs(arguments, 'binding', function (x) {
	      return Util.canRepresentSubpath(x) ? 'subpath' : null;
	    }, '?pred');
	   ...
	   * @returns {Function} callback
	   * @memberOf Callback */
	  onKey: function onKey(cb, key, shiftKey, ctrlKey) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.connect = __webpack_require__(191);

	Reflux.connectFilter = __webpack_require__(193);

	Reflux.ListenerMixin = __webpack_require__(192);

	Reflux.listenTo = __webpack_require__(194);

	Reflux.listenToMany = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(179);

	Reflux.ListenerMethods = __webpack_require__(180);

	Reflux.PublisherMethods = __webpack_require__(189);

	Reflux.StoreMethods = __webpack_require__(188);

	Reflux.createAction = __webpack_require__(190);

	Reflux.createStore = __webpack_require__(184);

	var maker = __webpack_require__(183).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(181);
	...
	Reflux.__keep = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(181),
	    maker = __webpack_require__(183).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(184),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(181),
	    Keep = __webpack_require__(185),
	    mixer = __webpack_require__(186),
	    bindMethods = __webpack_require__(187);
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(188),
	        PublisherMethods = __webpack_require__(189),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(181),
	    ActionMethods = __webpack_require__(179),
	    PublisherMethods = __webpack_require__(189),
	    Keep = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(180),
	    ListenerMixin = __webpack_require__(192),
	    _ = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(maCtx) {
	    ...
	    return _reflux2.default.createStore({
	        listenables: [_TodoActions2.default],
	        init: function init() {
	        ...
	        onCreate: function onCreate(content) {
	            this.itemsBinding.update(function (todos) {
	                return todos.unshift(_immutable2.default.Map({
	                    id: new Date().getTime() + 2016,
	                    content: content,
	                    completed: false,
	                    editing: false,
	        ...
	        onFilterBy: function onFilterBy(filter) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateTodo = _react2.default.createClass({
	    ...
	    _handleCreate: function _handleCreate(e) {
	        ...
	        if (content) {
	            _TodoActions2.default.create(content);
	        }
	        e.target.value = '';
	    },
	    render: function render() {
	        return _react2.default.createElement(
	            'header',
	            null,
	            _react2.default.createElement(_morearty2.default.DOM.input, { className: 'content-create',
	                ref: 'createTodo',
	                type: 'text',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = _react2.default.createClass({
	    ...
	    mixins: [_morearty2.default.Mixin],
	    _shouldShow: function _shouldShow(todoItem) {
	        var filterBinding = this.getDefaultBinding().get('filter');
	    ...
	    _renderTodoItems: function _renderTodoItems() {
	        var _this = this;

	        var itemsBinding = this.getDefaultBinding().sub('items');
	        var items = itemsBinding.get();
	        return items.map(function (todo, index) {
	            var itemBinding = itemsBinding.sub(index);
	            return _this._shouldShow(todo) ? _react2.default.createElement(_TodoItem2.default, { binding: itemBinding, key: itemBinding.toJS('id') }) : null;
	        }).toArray();
	    },
	    render: function render() {
	        return _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolBar = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var done = immutableItems.filter(function (item, index) {
	            return item.get('completed');
	        }).size;
	        var total = immutableItems.size;
	        return _react2.default.createElement(
	            'footer',
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { onClick: filterBy.bind(_TodoActions2.default, 'all'), href: '#', className: filter === 'all' ? 'selected' : '' },
	                        'All'
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { onClick: filterBy.bind(_TodoActions2.default, 'active'), href: '#', className: filter === 'active' ? 'selected' : '' },
	                        'Active'
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { onClick: filterBy.bind(_TodoActions2.default, 'completed'), href: '#', className: filter === 'completed' ? 'selected' : '' },
	                        'Completed'
	                    )
	                )
	            ),
	            _react2.default.createElement(
	                ...
	                { style: { display: done > 0 ? '' : 'none' },
	                    onClick: _TodoActions2.default.clearCompleted,
